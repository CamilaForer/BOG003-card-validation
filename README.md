...
Este proyecto busca validar las tarjetas de crédito de los clientes de la pasteleria "Bakery" cuando quieran hacer sus comprar por medio de este pago electrónico, solo con insertar el número de su tarjeta y dar click en validad se podra verificar si es valida o no para continuar con la compra. 
...
![Imagen final pagina principal](src/img/Mockups/PantallaPrincipal.JPG)
